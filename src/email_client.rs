...
impl EmailClient {
    ...
    pub async fn send_email(
        ...
        let url = self.base_url.join("email").expect("Bad URL");
...
mod tests {
    ...
    fn email() -> SubscriberEmail {
        ...
        SubscriberEmail::parse(s.as_ref()).unwrap()
    }
    ...
    async fn send_email_sends_the_expected_request() {
        ...
        Mock::given(header_exists("X-Postmark-Server-Token"))
            ...
            .and(path("/email"))
            .and(wiremock::matchers::method("POST")) // Bug CLion
            // .and(method("POST"))  // Bug CLion
